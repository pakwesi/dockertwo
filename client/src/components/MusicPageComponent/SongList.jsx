...
const SongList = () => {
    ...
    console.log("http://192.168.99.115:8000/graphql/media/" + detailsMusic[0].file)
        ...
        {Object.entries(detailsData).map(
          ([key, item], i) => (
            ...
            <Media>
                  <div className="media">
                    <div className="media-player">
                      <Player onDuration src={"http://192.168.99.115:8000/graphql/media/" + detailsMusic[i].file} />
                    </div>
            ...
            cover={
              ...
              <img key={i} src={"http://192.168.99.115:8000/graphql/media/" + detailsImage[i].file} alt={detailsImage[i].file} />
              </div>
            }
            actions={[
              <CustomPlayPause />,
